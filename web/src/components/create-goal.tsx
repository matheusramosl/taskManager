          ...
          <form onSubmit={handleSubmit(handleCreateGoal)} className='flex-1 flex flex-col justify-between'>
            <div className='flex flex-col gap-6'>
              <div className='flex flex-col gap-2'>
                ...
                <Input id='title' autoFocus placeholder='Praticar exercício, nadar, etc...' {...register('title')}/>
              ...
              <div className='flex flex-col gap-2'>
                ...
                render={({ field }) => {
                    return (
                        <RadioGroup onValueChange={(value) => field.onChange(Number(value))} // Converte para número ao mudar
